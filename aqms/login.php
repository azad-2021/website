        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
					...
					<strong>You must be logged in to view the AQMS data.</strong>
					</div>
					...
					<div class="form-group col-lg-12">
						<a href="register.php"><button type="submit" disabled class="btn btn-default">Not a Member? Register here</button></a>
					</div>
